...
def disable_broadcast_signals():
    post_save.disconnect(signals.post_save_broadcast,
                         sender='notification.Broadcast')
    pre_delete.disconnect(signals.pre_delete_broadcast,
                          sender='notification.Broadcast')

    yield

    post_save.connect(signals.post_save_broadcast,
                      sender='notification.Broadcast')
    pre_delete.connect(signals.pre_delete_broadcast,
                       sender='notification.Broadcast')
